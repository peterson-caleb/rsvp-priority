...
def manage_invitees(event_id):
    ...
    # THIS IS THE NEW LOGIC TO PREPARE A LIST OF IDs
    ...
    return render_template(
        ...
        current_invitee_ids=current_invitee_ids # Pass the new list to the template
    )

# In app/routes/event_routes.py
...
def add_invitees(event_id):
    ...
    try:
        ...
        # Display a message based on the actual number added
        if added_count > 0:
